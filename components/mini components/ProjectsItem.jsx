...
const ProjectsItem = ({ title, type, backgroundImage, projectUrl }) => {
  return (
    <div className="mb-4 md:mb-0 hover:shadow-2xl shadow-gray-900 rounded-xl relative group border-4 border-[#F53062] hover:bg-gradient-to-r from-[#1E2022] to-[#6a6c6f] ease-in duration-300   bg-opacity-50 flex justify-center items-center">
      <Image
        src={backgroundImage}
        alt="projects"
